    ...
    return (
        <>
            <div className={styles.header}>
                <Link href="/">
                    <svg className={styles.logo} viewBox="0 0 2298.41 200">
                        <g>
                            <path
                            ...
                            />
                            <path className={styles.cls3} d="M1217.41,88.53H1159.5V63.2h57.91" />
                        </g>
                    </svg>
                </Link>
                {isMenuOpen && (
                ...
                {isMenuOpen && (
                    <>
                        {nav.map((item, index) => (
                            <div
                                className={`styles.menu_link_${item.class}`}
                                onClick={() => setIsMenuOpen(false)}
                                key={index}
                            >
                                <Link href={item.href}>
                                    <a className={styles.menu_link_name}>
                                        <i>{FaLinkedin}</i> {item.name}
                                    </a>
                                </Link>
                            </div>
                        ))}
                ...
                <div className={styles.nav_links}>
                    <div></div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/">
                            <a className={styles.nav_link_name}>Home</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/services">
                            <a className={styles.nav_link_name}>Services</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/zeronetenergy">
                            <a className={styles.nav_link_name}>Zero Net Energy</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/buildingcertification">
                            <a className={styles.nav_link_name}>Building Certification</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/aboutus">
                            <a className={styles.nav_link_name}>About Us</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/contact">
                            <a className={styles.nav_link_name}>Contact</a>
                        </Link>
                    </div>
                    <div className={styles.nav_link} onClick={() => setIsMenuOpen(false)}>
                        <Link href="/linkedin">
                            <a className={styles.nav_link_name}>LinkedIn</a>
                        </Link>
                    </div>
                </div>
            </div>
